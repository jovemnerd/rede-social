	...
	b.widget("ui.tagit", {
		...
		_create : function() {
			...
			if (this.options.singleField)
				if (this.options.singleFieldNode) {
					...
					this.options.singleFieldNode = b('<input type="hidden" style="display:none;" value="" name="' + this.options.fieldName + '" />'), this.tagList.after(this.options.singleFieldNode);
			...
			this.tagInput.keydown(function(c) {
				if (c.which == b.ui.keyCode.BACKSPACE && "" === a.tagInput.val()) {
					...
					a.options.removeConfirmation && a._lastTag().removeClass("remove ui-state-highlight");
				if (c.which === b.ui.keyCode.COMMA || c.which === b.ui.keyCode.ENTER || c.which == b.ui.keyCode.TAB && "" !== a.tagInput.val() || c.which == b.ui.keyCode.SPACE && !0 !== a.options.allowSpaces && ('"' != b.trim(a.tagInput.val()).replace(/^s*/, "").charAt(0) || '"' == b.trim(a.tagInput.val()).charAt(0) && '"' == b.trim(a.tagInput.val()).charAt(b.trim(a.tagInput.val()).length - 1) && 0 !== b.trim(a.tagInput.val()).length - 1))
					c.which === b.ui.keyCode.ENTER && "" === a.tagInput.val() || c.preventDefault(), a.tagInput.data("autocomplete-open") || a.createTag(a._cleanedInput())
			}).blur(function() {
		...
		_findTagByLabel : function(a) {
			...
			this._tags().each(function() {
				if (d._formatStr(a) == d._formatStr(d.tagLabel(this)))
					return c = b(this), !1
			});
			return c
		},
		...
		createTag : function(a, d, c) {
			...
			if ("" === a)
				return !1;
			if (!this.options.allowDuplicates && !this._isNew(a))
				return a = this._findTagByLabel(a), !1 !== this._trigger("onTagExists", null, {
					existingTag : a,
		...
		removeTag : function(a, d) {
			...
			if (!1 !== this._trigger("beforeTagRemoved", null, {
				...
				if (this.options.singleField) {
					var c = this.assignedTags(), e = this.tagLabel(a), c = b.grep(c, function(a) {
						return a != e
					});
		...
		removeTagByLabel : function(a, b) {
			...
			if (!c)
				throw "No such tag exists with the name '" + a + "'";
			this.removeTag(c, b)
		},
		removeAll : function() {
			var a = this;
